...
async def upload_video(
    ...
    video_doc = {
        ...
        "analysis_result": None,    # Will be filled by ai-service
        "type": "uploaded"          # vs "stream"
    }
    ...
    return {
        ...
        "file_size_mb": video_doc["file_size_mb"],
        "status": "uploaded",
...
# -------------------------------------------------------
@router.post("/stream-url", status_code=201)
async def register_stream(
    ...
    result = await db["videos"].insert_one(stream_doc)
